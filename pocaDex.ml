...
let movedex = MoveDex.add "RAZOR WIND" {name="RAZOR WIND"; move_type=TNormal; status_effect=MNormal; status_probability=100; accuracy=75; damage=80; max_pp=10; effect=MCharge; pp=10; move_category=ESpecial} movedex
...
let movedex = MoveDex.add "HYPER BEAM" {name="HYPER BEAM"; move_type=TNormal; status_effect=MNormal; status_probability=100; accuracy=90; damage=150; max_pp=5; effect=MCharge; pp=5; move_category=ESpecial} movedex
...
let movedex = MoveDex.add "TOXIC" {name="TOXIC"; move_type=TPoison; status_effect=MPoison; status_probability=100; accuracy=85; damage=0; max_pp=10; effect=MNone; pp=10; move_category=ESpecial} movedex
...
let movedex = MoveDex.add "QUICK ATTACK" {name="QUICK ATTACK"; move_type=TNormal; status_effect=MNormal; status_probability=100; accuracy=100; damage=40; max_pp=30; effect=MPriorityHit; pp=30; move_category=ESpecial} movedex
...
let movedex = MoveDex.add "SKY ATTACK" {name="SKY ATTACK"; move_type=TFlying; status_effect=MNormal; status_probability=100; accuracy=90; damage=140; max_pp=5; effect=MCharge; pp=5; move_category=ESpecial} movedex
...
let movedex = MoveDex.add "MACH PUNCH" {name="MACH PUNCH"; move_type=TFighting; status_effect=MNormal; status_probability=100; accuracy=100; damage=40; max_pp=30; effect=MPriorityHit; pp=30; move_category=ESpecial} movedex
...
let movedex = MoveDex.add "EXTREMESPEED" {name="EXTREMESPEED"; move_type=TNormal; status_effect=MNormal; status_probability=100; accuracy=100; damage=80; max_pp=5; effect=MPriorityHit; pp=5; move_category=ESpecial} movedex
